...
export default function AcessoBloqueadoPage() {
  return (
    <div className="flex min-h-screen items-center justify-center bg-slate-50 px-4">
      <div className="w-full max-w-md rounded-3xl border border-red-100 bg-white p-8 text-center shadow-soft">
        ...
        <Link
          href="/login"
          className="mt-6 block w-full rounded-xl bg-slate-900 px-4 py-3 text-sm font-black text-white hover:bg-slate-800"
        >
          Voltar ao login
        </Link>
      </div>
